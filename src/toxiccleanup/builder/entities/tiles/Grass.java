...
/**
 * A {@link Grass} tile is a purely decorative ground tile with no game mechanics. The player can walk over it freely without triggering any interaction.
 * It is rendered using the default sprite of {@link SpriteGallery#grass} and does not accept any stacked machines.
 *
 * @stage1
 */
